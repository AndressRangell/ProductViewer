...
import com.cursosandroidant.productviewer.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setNewQuantity() {
        ...
        val newQuantityStr = getString(
            R.string.detail_total_price, selectedProduct.totalPrice(),
    ...
    private fun addToCart(product: Product) {
        ...
        Snackbar.make(
            binding.root, getString(R.string.main_message_product_added, product.name),
